...
for arg in "$@"; do
    case $arg in
        ...
        printf '%s\n%s\n%s\n%s\n%s\n%s\n%s\n'\
                ...
                "-g, --gpus:    The number of M2050 GPUs to reserve. Default is 0."\
                "-j, --jobname: The name of the job as shown on squeue. Default is djg-%j."
        return
           ;;
        -f|--file)
...
echo "#SBATCH --output=/home/dgillcrist/outfiles/slurm-%j.out" >> ~/ActualSlurmSubmitter.slurm
echo -e "#SBATCH --error=/home/dgillcrist/outfiles/slurm-%j.err\n" >> ~/ActualSlurmSubmitter.slurm
...
echo -e "#SBATCH --gres=gpu:M2050:$gpus\n" >> ~/ActualSlurmSubmitter.slurm
