...
Once both of these things are accomplished, you can run the following from any directory. NOTE: `diff -Please do not put astericks around your values/names that follow the tags, just write the name/value as it is.`
```
